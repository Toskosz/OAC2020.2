...
show:                                   # @show
        ...
        sw a0, -12(s0)
        sw a1, -16(s0)
       	mv t0,a0	# %0 representa o primeiro argumento de uma função e por convenção correposnde a a0
	mv t1,a1	# %1 representa o segundo argumento de uma função e por convenção correposnde a a1
	mv t2,zero
